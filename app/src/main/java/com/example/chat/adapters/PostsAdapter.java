...
import com.example.chat.activities.PostDetailActivity;
import com.example.chat.models.Like;
...
public class PostsAdapter extends FirestoreRecyclerAdapter<Post, PostsAdapter.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull final Post post) {
        ...
        holder.textViewLanguage.setText(post.getTitle().toUpperCase());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            textViewLanguage = view.findViewById(R.id.textViewLanguagePostCard);
