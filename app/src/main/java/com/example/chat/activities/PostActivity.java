...
import com.example.chat.providers.ImageProvider;
import com.example.chat.providers.PostProvider;
import com.example.chat.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    TextInputEditText mTextInputLevel;
    TextInputEditText mTextInputDescription;
    ImageView mImageViewJava;
    ImageView mImageViewPython;
    ImageView mImageViewJavaScript;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextInputLevel = findViewById(R.id.textInputLevel);
        mTextInputDescription = findViewById(R.id.textInputDescription);
        mImageViewJava = findViewById(R.id.imageViewJava);
        mImageViewPython = findViewById(R.id.imageViewPython);
        mImageViewJavaScript = findViewById(R.id.imageViewJS);
        mImageViewC = findViewById(R.id.imageViewC);
        ...
        mImageViewJava.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "Java";
        ...
        mImageViewPython.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "Python";
                mTextViewCategory.setText(mCategory);
        ...
        mImageViewJavaScript.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "JavaScript";
                mTextViewCategory.setText(mCategory);
            }
        });

        mImageViewC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "C";
                mTextViewCategory.setText(mCategory);
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "com.example.chat", photoFile);
    ...
    private void clickPost() {
        ...
        mTitle = mTextInputLevel.getText().toString();
